...
namespace Campus_Harburg_Android
{
    ...
    public class Activity_About : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Form_About);
            ...
            var textV = FindViewById<TextView>(Resource.Id.textView11);
            textV.Text = TextContainer.About_Notes;
