...
{
    [Activity(Label = "Campus Harburg", Icon = "@drawable/icon")]
    public class Activity_Start : AppCompatActivity
    {
        DrawerLayout drawerLayout;
        Campus_Harburg_Core.Links lk = new Campus_Harburg_Core.Links();
        ...
        protected override void OnResume()
        {
            ...
            navigationView.SetCheckedItem(Resource.Id.nav_start);
        }
