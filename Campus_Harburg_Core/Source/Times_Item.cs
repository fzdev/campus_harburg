...
{
    //Struktur zum speichern der Semesterzeiten
    public class Times_Item
    {
        //Name des Semesters (z.B. Sommersemester 2016)
        public string title { get; set; }
        //Zeitraum des kompletten Semesters
        public string time_complete { get; set; }
        //Datum des Vorlesungsbegins
        public string time_start { get; set; }
        //Datum des Vorlesungsende
        public string time_end { get; set; }
        //Zeitraum der Ferien
        public string time_holidays { get; set; }
    }
}
